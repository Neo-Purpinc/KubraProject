...
<head>
    ...
    <link href="<c:url value="/assets/css/black-dashboard.min.css" />" rel="stylesheet">
    <link href="<c:url value="/assets/css/tempusdominus-bootstrap.css" />" rel="stylesheet">
    ...
    <script src="<c:url value="/assets/js/plugins/tempusdominus-bootstrap.js"/>"></script>
